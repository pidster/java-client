...
/**
 * An object of this type is supplied to {@link TransactionFunction}s to provide access to the object
 * graph stored by GoshawkDB. {@link TransactionImpl} must not be used outside of a transaction.
 */
final class TransactionImpl<Result> implements Transaction {
